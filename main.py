...
l_nome = Label(frame_cima, text="Cadastro Aluno", height=1, anchor=NE, font=('verdana 17 bold'), bg=co3, fg=co1)
...
def mostrar():
    ...
    list_header = ['Nome', 'Sexo', 'ra', 'email']
    ...
    tree.heading(2, text='Ra', anchor=NW)
...
def inserir():
    ...
    dados = [nome, sexo, ra, email]

    if nome == '' or sexo == '' or ra == '' or email == '':
...
def atualizar():
    try:
        ...
        def confirmar():
            ...
            dados = [ra, novo_nome, novo_sexo, novo_ra, novo_email]
...
l_ra = Label(frame_baixo, text="R.A *", height=1, anchor=NW, font='Ivy 10 ', bg=co1, fg=co4)
l_ra.place(x=10, y=80)
e_ra = Entry(frame_baixo, width=25, justify='left', font=("", 10), highlightthickness=1, relief="flat")
e_ra.place(x=80, y=80)
